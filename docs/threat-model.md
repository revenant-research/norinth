...
| Malicious or compromised SDK | Apache-2.0, no runtime dependencies, about 2,000 lines (`wc -l packages/python-sdk/norinth_logger/*.py`); fail-open so a transport failure does not raise into the host app; content off by default. |
